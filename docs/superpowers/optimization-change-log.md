...
| 文档 diff | **待阶段 1-C 同步 `docs/protocol/v1.md`**（本任务按约束不改 `docs/protocol/**`，文档同步由阶段 1-C 统一做）。**这是 AGENTS.md §2.1 硬门禁的一笔显式欠账，阶段 1-C 未完成前本条契约变更不算收口。** |
...
| 文档 diff | **待阶段 1-C 同步 `docs/protocol/v2.md`**（本任务按约束不改 `docs/protocol/**`，文档同步由阶段 1-C 统一做）。**这是 AGENTS.md §2.1 硬门禁的一笔显式欠账，阶段 1-C 未完成前本条契约变更不算收口。** |
